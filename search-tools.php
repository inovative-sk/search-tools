	...
	class SETO_SearchTools {
		...
		public function enqueue_assets() {			
			if( $GLOBALS['hook_suffix'] === "index.php" ){
				wp_enqueue_style("search-tools-dashboard-widget", SEARCH_TOOLS_ASSETS_URL . "css/dashboard-widget.css", false, "1.0.1", "all");
				wp_enqueue_script("search-tools-dashboard-widget", SEARCH_TOOLS_ASSETS_URL . "js/dashboard-widget.js", ["jquery"], "1.0.1", ["in_footer" => true]);
			}
